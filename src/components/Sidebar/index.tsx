            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                        ...
                        >
                          ...
                          <li>
                            <Link
                              to="/dashboard/sales"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === '/dashboard/sales' && '!text-white'
                              }`}
                            >
                              Sales
                            </Link>
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === '/dashboard/reports' && '!text-white'
                              }`}
                            >
                              Reports
                            </Link>
              ...
              <li>
                ...
                >
                  ...
                  >
                    <path
                      d="M9.0002 7.79065C11.0814 7.79065 12.7689 6.1594 12.7689 4.1344C12.7689 2.1094 11.0814 0.478149 9.0002 0.478149C6.91895 0.478149 5.23145 2.1094 5.23145 4.1344C5.23145 6.1594 6.91895 7.79065 9.0002 7.79065Z"
                      fill=""
                    />
                    <path
              ...
              <li>
                ...
                >
                  ...
                  >
                    <path
                      d="M9 12.8771C11.1097 12.8771 12.8253 11.1614 12.8253 9.05205C12.8253 6.94268 11.1097 5.22705 9 5.22705C6.89062 5.22705 5.175 6.94268 5.175 9.05205C5.175 11.1614 6.89062 12.8771 9 12.8771Z"
                      fill=""
                    />
                  </svg>
                  Settings
                      ...
                      <div className="overflow-hidden">
                        ...
                        <li>
                          <Link
                            ...
                            className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                              pathname.includes('form-elements') && '!text-white'
                            }`}
                          >
                            Form Elements
                          </Link>
                        ...
                        <li>
                          <Link
                            ...
                            className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                              pathname.includes('form-layout') && '!text-white'
                            }`}
                          >
                            Form Layout
                          </Link>
              ...
              <li>
                ...
                >
                  ...
                  >
                    <path
                      d="M15.7501 0.55835H2.2501C1.29385 0.55835 0.506348 1.34585 0.506348 2.3021V15.8021C0.506348 16.7584 1.29385 17.574 2.27822 17.574H15.7782C16.7345 17.574 17.5501 16.7865 17.5501 15.8021V2.3021C17.522 1.34585 16.7063 0.55835 15.7501 0.55835Z"
                      fill=""
                    />
                  </svg>
                  Tables
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              <li>
                ...
                >
                  ...
                  >
                    <path
                      d="M15.3845 8.7427H9.1126V2.69582C9.1126 2.35832 8.83135 2.07707 8.49385 2.07707C8.40947 2.07707 8.3251 2.07707 8.24072 2.07707C3.96572 2.04895 0.506348 5.53645 0.506348 9.81145C0.506348 14.0864 3.99385 17.5739 8.26885 17.5739C12.5438 17.5739 16.0313 14.0864 16.0313 9.81145C16.0313 9.6427 16.0313 9.47395 16.0032 9.33332C16.0032 8.99582 15.722 8.7427 15.3845 8.7427Z"
                      fill=""
                    />
                  </svg>
                  Chart
                      ...
                      <div className="overflow-hidden">
                        ...
                        <li>
                          <Link
                            to="/auth/signup"
                            className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                              pathname.includes('/auth/signup') && '!text-white'
                            }`}
                          >
                            Sign Up
                          </Link>
